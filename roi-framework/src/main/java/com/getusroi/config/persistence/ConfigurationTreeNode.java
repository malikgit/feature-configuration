...
{
	static final Logger logger = (Logger) LoggerFactory.getLogger(ConfigurationTreeNode.class);
	...
	public boolean addChildren(ConfigurationTreeNode childNode)
	{
		...
		logger.debug("parentNodeId :: "+parentNodeId+" "+"nodeId :: "+nodeId+" "+"childNode :: "+childNode);
